"""
Django settings for hls_gateway project.
...
SECRET_KEY = os.getenv('SECRET_KEY', default='l2_v8kreko$JustSomethingFake')
...
WSGI_APPLICATION = 'hls_gateway.wsgi.application'
